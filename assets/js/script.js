...
//display d10 images to player-result div//
     if (d10PlayerRoll === 1) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 1";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[0];
   } if (d10PlayerRoll === 2) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 2";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[1];
   } if (d10PlayerRoll === 3) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 3";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[2];
   } if (d10PlayerRoll === 4) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 4";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[3];
   } if (d10PlayerRoll === 5) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 5";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[4];
   } if (d10PlayerRoll === 6) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 6";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[5];
   } if (d10PlayerRoll === 7) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 7";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[6];
   } if (d10PlayerRoll === 8) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 8";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[7];
   } if (d10PlayerRoll === 9) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 9";
    document.getElementById('d10-dice-image-one').src = d10DiceImageArray[8];
   } if (d10PlayerRoll === 10) {
    document.getElementById('d10-dice-image-one').alt = "you rolled a 10";
